...
export function Alert({
  ...
  return (
    <>
      <div className="w-full h-full bg-foreground-dark/90 fixed inset-x-0 z-98 p-5">
            ...
            <div className="justify-center items-center w-full flex flex-col gap-6 mt-8">
              <div className="flex gap-2 items-center justify-center max-w-5xl mb-8">
                <div className="flex flex-col gap-4 items-center">
                  <h1 className="text-base md:text-xl bg-clip-text text-transparent bg-linear-to-r from-secondary to-primary font-bold mb-4">
                    Parece que houve um erro ao gerar um estudo com a IA,
                    Estamos trabalhando para resolver!
                  </h1>
                  <p className="text-sm md:text-lg text-foreground mb-8">
